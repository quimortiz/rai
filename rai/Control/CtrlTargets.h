...
struct CtrlMovingTarget {
  ...
  virtual rai::ActStatus step(double tau, CtrlObjective* o, const arr& y_real) = 0; //step forward, updating the target based on y_real
...
struct CtrlTarget_Const : CtrlMovingTarget {
  CtrlTarget_Const() {}
  virtual rai::ActStatus step(double tau, CtrlObjective* o, const arr& y_real);
